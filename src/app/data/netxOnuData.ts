...
export const AUTHENTIC_NETX_ONUS: NetxOnuRecord[] = [
  ...
  {
    "id": "onu-netx-real-313",
    "mac": "4c:46:d1:97:e1:f3",
    "ponPort": "epon 0/4",
    "status": "offline",
    "rxPower": "-20.0 dBm",
    "customer": "Unassigned",
